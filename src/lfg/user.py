...
class User:
    def __init__(self, user_id: int, user_name: str, character: str, roles: list[Role]):
    ...
    def __repr__(self):
        return f"User(user_id={self.user_id}, user_name={self.user_name}, character={self.character}, roles={self.roles})"
